...
Minor fixes.
= 1.2.6= 
Fixed editor/admin preview XSS vulnerability.
= 1.2.5=
Fixed rare incompatibility issue.
= 1.2.4=
Fixed an issue with certain characters like "£".
= 1.2.3=
Optimizations.
= 1.2.2=
Fixed an issue that would sometimes cause issues with URL encoded links.
= 1.2.1 =
